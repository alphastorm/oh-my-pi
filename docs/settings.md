...
| `task.agentTierOverrides` | record | `{}`      | Sparse exact-name overrides for spawned task/eval agents. Values: `inherit`, `none`, `auto`, `default`, `flex`, `scale`, `priority`. An entry overrides `tier.subagent`; concrete values apply only to the resolved model's provider family. |
...
| `providers.tinyModel`               | enum    | `online`  | `online` or a local model (`lfm2.5-350m`, `lfm2-350m`, `qwen3-0.6b`, `gemma-270m`, `qwen2.5-0.5b`, `lfm2-700m`).                                                                                                                                                                                                                                                                                                                                      |
