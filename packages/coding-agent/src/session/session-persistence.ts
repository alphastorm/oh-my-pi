...
export function isProviderAuthenticatedBlock(obj: unknown, key?: string): boolean {
	if (typeof obj !== "object" || obj === null) return false;
	// Native compaction carriers are atomic, including the untyped preserveData slot.
	if (
...
function externalizeForPersistence(
	...
	if (isProviderAuthenticatedBlock(obj, key)) return obj;
	if (
		typeof obj === "object" &&
		"type" in obj &&
